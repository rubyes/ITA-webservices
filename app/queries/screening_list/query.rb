module ScreeningList
  class Query < ::Query
    ...
    def extract_other_options(options)
      ...
      @entity_number = options[:entity_number] if options[:entity_number].present?
    ...
    def generate_filter(json)
      json.filter do
        json.bool do
          json.must do
            ...
            json.child! { json.term { json.entity_number @entity_number } } if @entity_number.present?
          ...
          end if @type || @sources.any? || @start_date || @end_date || @issue_date || @expiration_date || @entity_number
          json.set! 'should' do
      ...
      end if @countries || @type || @sources.any? || @start_date || @end_date || @issue_date || @expiration_date || @entity_number.present?
    end
  end
end
